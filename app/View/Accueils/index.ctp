...
<div id="page-container" class="row">
				...
				<table cellpadding="0" cellspacing="0" class="table table-striped table-bordered">
					<thead>
						<tr>
															...
															<th><?php echo $this->Paginator->sort('compte', 'Compte'); ?></th>
	...
	<tr>
		...
		<td><?php echo $this->element('value',array('page'=>'index', 'name'=>'compte', 'type'=>'virtual', 'v'=>$accueil['Accueil']['compte'])); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php if($user_level>=5) echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span> '.__('Modifier'), array('action' => 'edit', $accueil['Accueil']['id']), array('class' => 'btn btn-default btn-xs', 'escape' => FALSE)); ?>
		</td>
	</tr>
<?php endforeach; ?>
					</tbody>
