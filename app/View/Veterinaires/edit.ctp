			...
			<?php echo $this->MyForm->create('Veterinaire', array('inputDefaults' => array('label' => false), 'role' => 'form')); ?>
				<fieldset>
                                    ...
                                    <div class="btn-toolbar pull-right">
                                                                                <div class="btn-group">
                                            <?php echo $this->Html->link('<span class="glyphicon glyphicon-file"></span> '.__('Retour fiche Veterinaire'), array('action' => 'view', $veterinaire['Veterinaire']['id']), array('class' => 'btn btn-default', 'escape' => FALSE)); ?>                                        </div>
                                                                                <div class="btn-group">
                                            <?php echo $this->Html->link('<span class="glyphicon glyphicon-list"></span> '.__('Retour à la liste'), array('action' => 'index'), array('class' => 'btn btn-default', 'escape' => FALSE)); ?>                                        </div>
                                    </div>
                    
                                                                        <h2><?php  echo __('Modifier Veterinaire').': '.$veterinaire['Veterinaire']['nom']; ?></h2>
